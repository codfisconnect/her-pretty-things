  ...
  return (
    <footer className="site-footer">
      <div className="footer-main container">
        ...
        <div className="footer-column"><h3>Customer Care</h3><a href="mailto:shop.herprettythings@gmail.com">Contact Us</a><a href="mailto:hello@herprettythings.com">FAQ</a><Link to="/shipping">Shipping & Delivery</Link><a href="mailto:hello@herprettythings.com">Returns</a></div>
